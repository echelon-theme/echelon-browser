...
community-2 = { -brand-short-name } is designed by <label data-l10n-name="community-mozillaLink">The Echelon Team</label>, a group working together to restore the beloved designs of older versions of Firefox.
